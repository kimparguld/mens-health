    ...
    <main className="mx-auto max-w-4xl px-4 py-6">
      ...
      <header className="mb-10">
        ...
        <p className="mt-3 text-lg leading-relaxed text-gray-600">
          ...
          health content — so you can follow a video summary without Googling
          every other word.
        </p>
      </header>
      ...
      <section className="mb-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
        {sortedTerms.map((term) => (
          <Link
            ...
            className="rounded-xl border border-gray-200 bg-white px-5 py-4 transition hover:border-emerald-300 hover:shadow-sm"
          >
