      ...
      sections: [
        {
          ...
          citations: [
            {
              label:
                'Harman et al., J Clin Endocrinol Metab (2001) — Baltimore Longitudinal Study of Aging',
              url: 'https://pubmed.ncbi.nlm.nih.gov/11158037/',
            },
            {
              label:
                'Travison et al., J Clin Endocrinol Metab (2007) — population-level decline in serum testosterone',
        ...
        {
          heading:
            "Symptoms often blamed on low testosterone — that usually aren't",
          paragraphs: [
        ...
        {
          heading:
            "What resistance training actually does — and doesn't do — for testosterone",
          paragraphs: [
            'Resistance training gets credited with "boosting testosterone" constantly, and the real picture is more nuanced than that framing suggests. A single training session does produce an acute, short-lived spike in circulating testosterone — that part is well documented. What\'s less settled is whether a regular resistance-training habit raises your baseline, resting testosterone level over the long run. A systematic review and meta-analysis focused on older men found that resistance training specifically did not reliably shift basal testosterone levels — the pooled effect was close to zero, and results varied considerably between individual studies (the same review found aerobic and interval training produced small but significant increases, an effect resistance training did not share) [1].',
          ...
          citations: [
            {
              label:
                'Frontiers in Physiology systematic review & meta-analysis (2019) — Short-Term Exercise Training Inconsistently Influences Basal Testosterone in Older Men',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Separately, TRT reliably raises hematocrit (red blood cell concentration), which increases clotting risk and needs periodic blood-test monitoring [3]. It also suppresses natural sperm production, since exogenous testosterone shuts down the body's own signal to produce it — relevant for men who haven't finished building their family, who should discuss fertility-preserving options with a doctor before starting. None of this makes TRT inherently dangerous for the right patient under proper monitoring — it makes it a real medical treatment with a real risk-benefit calculation, which is exactly why it requires a diagnosis, blood work, and an ongoing relationship with a doctor rather than a self-directed decision or an online purchase.",
          ],
          citations: [
            {
              label:
                'Bhasin et al., Endocrine Society Clinical Practice Guideline, J Clin Endocrinol Metab (2018)',
              url: 'https://pubmed.ncbi.nlm.nih.gov/29562364/',
            },
            {
              label:
                'Lincoff et al., NEJM (2023) — Cardiovascular Safety of Testosterone-Replacement Therapy (TRAVERSE trial)',
              url: 'https://www.nejm.org/doi/full/10.1056/NEJMoa2215025',
            },
            {
              label:
                'Management of Adverse Effects in Testosterone Replacement Therapy, International Brazilian Journal of Urology (2025)',
