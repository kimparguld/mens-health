  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <p className="text-sm text-gray-500">
        ...
        only one that needs a connected account here. YouTube Community and
        Reddit are always posted manually from{' '}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex flex-col justify-between gap-4 rounded-lg border border-dashed bg-gray-50 p-4 opacity-70">
          ...
          <p className="text-xs text-gray-500">
            ...
            pending TikTok Developer credentials — no connection available yet.
          </p>
        </div>
      </div>
