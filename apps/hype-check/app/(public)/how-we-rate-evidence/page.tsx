      ...
      <div className="mx-auto max-w-[720px] px-4 py-12">
        ...
        <section className="mb-10 space-y-4 leading-relaxed text-gray-700">
          ...
          <p>
            ...
            context: is this claim backed by solid, verifiable evidence, mixed
            results, or mostly anecdote and marketing? Without that context, it
          ...
          <p>
            ...
            information at time of review, not a comprehensive audit. They are a
            starting point for your own thinking — not a substitute for
        ...
        <section className="mb-10 space-y-4 leading-relaxed text-gray-700">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              Whether relevant regulators or consumer-protection bodies (FTC,
              SEC, BBB, etc.) have flagged or taken action on the product,
              course, or company
            </li>
            <li>
        ...
        <section className="mb-10 space-y-4 leading-relaxed text-gray-700">
          ...
          <p>
            Our evidence ratings are AI-assisted, not produced by financial or
            legal professionals. For high-risk categories — investment apps,
            side hustles, online courses, giveaways, remote job offers — ratings
            go through an additional human review step before publishing.
          </p>
          <p>
            Markets and companies change quickly. A claim rated
            &ldquo;mixed&rdquo; today may be re-rated as &ldquo;strong&rdquo;
            (or &ldquo;not supported&rdquo;) in future updates. We aim to
            refresh ratings periodically, but we cannot guarantee every rating
            reflects the very latest information.
          </p>
          <p>
