  ...
  return (
    <main className="mx-auto max-w-[720px] px-4 py-12">
      ...
      <p className="mb-8 text-lg leading-relaxed text-gray-600">
        Hype Check is transparent about how we earn money from content on this
        site.
      </p>
      ...
      <section className="mb-10 space-y-4 leading-relaxed text-gray-700">
        ...
        <p>
          ...
          click a link and make a purchase or sign up for a service, Hype Check
      ...
      <section className="mb-10 space-y-4 leading-relaxed text-gray-700">
        ...
        <p>
          ...
          analysis, or editorial summaries. We do not promote products, courses,
          or apps in exchange for positive coverage, and we do not accept
          payment to rate claims favourably.
        </p>
        <p>
          We only include affiliate links for products or services that are:
        </p>
        <ul className="list-disc space-y-1 pl-5">
          <li>Directly relevant to the topic being discussed</li>
          <li>
            From categories we have actually reviewed the evidence for (e.g., a
            budgeting app with a documented track record, not an unverified
            &ldquo;guaranteed returns&rdquo; pitch)
          </li>
          <li>
      ...
      <section className="mb-10 space-y-4 leading-relaxed text-gray-700">
        ...
        <p>
          ...
          between Hype Check and any brands, products, or services featured or
          linked on this site.
        </p>
        <p>
