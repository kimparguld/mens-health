      ...
      <section className="mb-10 space-y-6 leading-relaxed text-gray-700">
        <div>
          ...
          <p>
            ...
            categories including side hustles, online courses, viral products,
            investment apps, giveaways, and more. Searches are run on a
            scheduled basis. We track videos from a curated list of channels
            known to cover these categories — ranging from personal finance
            creators and consumer-protection accounts to independent product
            reviewers.
          </p>
          <p className="mt-2">
        ...
        <div>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>Extracted claims, each rated for evidence and risk level</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            giveaways, and remote job offers do not publish automatically. They
            enter a review queue visible to our editorial team. A human reviewer
            checks the AI output for accuracy, flags overreaching claims, and
            either approves or rejects the summary before it goes live.
          </p>
          <p className="mt-2">
        ...
        <div>
          ...
          <p>
            ...
            evidence ratings, takeaways, warnings, and the mandatory disclaimer.
            We never download, modify, or rehost YouTube videos.
          </p>
        </div>
