...
export function NewsletterSignupForm({ compact = false, className }: Props) {
  ...
  const btnClass = compact
    ? 'rounded bg-ink px-3 py-1.5 text-xs font-semibold text-white hover:bg-ink/80 disabled:opacity-50'
    : 'rounded-lg bg-ink px-5 py-2.5 text-sm font-semibold text-white hover:bg-ink/80 disabled:opacity-50';
